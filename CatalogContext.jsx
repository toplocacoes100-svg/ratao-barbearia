...
// Dias que faltam no banco usam o padrão; um dia gravado como null fica fechado.
const mergeSettings = (d) => ({ ...DEFAULT_SETTINGS, ...d, hours: { ...DEFAULT_SETTINGS.hours, ...(d.hours || {}) } });
...
export function CatalogProvider({ children }) {
  ...
  useEffect(() => {
    ...
    const u1 = onSnapshot(doc(db, 'settings', 'shop'), (s) => s.exists() && setSettings(mergeSettings(s.data())), fail);
